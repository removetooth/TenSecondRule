    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                v.vertex.xyz += (float3(1,1,1)*v.normal*max((sin((node_4453.g+((-1*node_8791)*recipObjScale.g)))-0.85),0.0));
